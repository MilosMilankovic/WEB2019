...
public class KorisnikDAO {
	...
	public static Korisnik get(String korisnickoIme) {
		...
		try {
				...
				if (rset.next()) {
						...
						System.out.println(id + " " + korisnickoIme+ " " +  lozinka+ " " + datumRegistracije+ " " + uloga+ " " + obrisan);
	...
	public static boolean add(Korisnik korisnik) {
		...
		PreparedStatement pstmt = null;
		try {
				String query = "INSERT INTO korisnik (korisnickoIme, lozinka, datumRegistracije, uloga, obrisan)"
								+ "VALUES (?, ?, ?, ?, ?)";
				pstmt = conn.prepareStatement(query);
